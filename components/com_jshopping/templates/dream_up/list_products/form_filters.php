...
<div class="sorting">
    ...
    <form action="<?php print $this->action;?>" method="post" name="sort_count" id="sort_count" >
        <a class="sort" onclick="submitListProductFilters(this)" >по алфавиту (А-Я)</a>
...
<!--                <input type="submit" value="по алфавиту (А-Я)" >-->
    ...
    <form action="<?php print $this->action;?>" method="post" name="sort_count" id="sort_count" >
        <a class="sort" onclick="submitListProductFilters(this)" >по алфавиту (Я-А)</a>
...
<!--                <input type="submit" value="о алфавиту (Я-А)" >-->
    ...
    <form action="<?php print $this->action;?>" method="post" name="sort_count" id="sort_count" >
        <a class="sort" onclick="submitListProductFilters(this)" >по возрастанию цены</a>
...
<!--                <input type="submit" value="по возрастанию цены" >-->
    ...
    <form action="<?php print $this->action;?>" method="post" name="sort_count" id="sort_count" >
        <a class="sort" onclick="submitListProductFilters(this)" >по убыванию цены</a>
