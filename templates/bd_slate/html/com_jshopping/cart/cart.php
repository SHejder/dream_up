...
?>
<div class="jshop" style="width:800px">
    <form action="<?php print SEFLink('index.php?option=com_jshopping&controller=cart&task=refresh'); ?>" method="post"
        ...
        <?php if ($countprod > 0) { ?>
            <table class="jshop" style="margin-top:10px">
                <tr id="checkout">
                    <td width="50%" class="td_1" align="right"><h3><a
                                    href="<?php print $this->href_shop; ?>"><?php print _JSHOP_BACK_TO_SHOP; ?></a></h3>
                    </td>
                    <td width="50%" class="td_2">
                        <!--      --><?php //if ($countprod>0){?><!--<h3><a href = "-->
                        <?php //print $this->href_checkout;?><!--">-->
                        <?php //print _JSHOP_CHECKOUT;?><!--</a></h3>--><?php //}?>
                    </td>
                </tr>
            </table>

            <table class="jshop cart" width="800px">
                <tr>
                    <th width="20%">
            ...
            <div class="cartdescr<?php if ($this->summ < $min_order_summ) echo ' min_order_summ'; ?>"><?php print $this->cartdescr; ?></div>
            ...
            <table class="jshop" style="margin-top:10px">
                <tr id="checkout">
                    <td width="50%" class="td_1" align="right"></td>
                    <td width="50%" class="td_2"><?php if ($countprod > 0) { ?><h3><a
