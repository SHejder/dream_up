...
<form action = "<?php print $this->action ?>" method = "post" name = "loginForm" onsubmit = "return validateCheckoutAdressForm('<?php print $this->live_path ?>', this.name)" >
    ...
    <table>
        ...
        <tr>
          ...
          <td>
            ...
            <input type = "text" name = "street_nr" id = "street_nr" value = "<?php if ($this->user->street_nr == '') print '№'; else print $this->user->street_nr?>" class="inputbox" style = "display: none;" />
          </td>
        </tr>
        <?php } ?>
    ...
    <div>
    <?php echo 'Доставка на Ваш адрес?'; // print _JSHOP_DELIVERY_ADRESS;?>
    ...
    <table>
        ...
        <tr>
          <td class="name">
            <?php echo 'Регион'; //print _JSHOP_STATE;?> <?php if ($config_fields['d_state']['require']){?><span>*</span><?php } ?>
          </td>
          <td>
        ...
        <tr>
          <td class="name">
            <?php echo 'Населённый пункт'; //print _JSHOP_CITY;?> <?php if ($config_fields['d_city']['require']){?><span>*</span><?php } ?>
          </td>
          <td>
        ...
        <tr>
          <td  class="name">
            <?php echo 'Улица'; //print _JSHOP_STREET_NR;?> <?php if ($config_fields['d_street']['require']){?><span>*</span><?php } ?>
          </td>
          <td>
...
<script>function saveDeliveryAddress()
 {
  ...
  return true;
        ...
        <input type = "submit" name = "next" value = "<?php print _JSHOP_NEXT ?>" class = "button" onclick="return saveDeliveryAddress();"/>
    </div>
</form>
</div>
