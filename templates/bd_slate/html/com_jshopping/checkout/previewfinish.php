...
<form name = "form_finish" action = "<?php print $this->action ?>" method = "post">
   <table class = "jshop" align="center" style="width:auto;margin-left:auto;margin-right:auto;">
     ...
     <tr>
        <td>
            <div class="row_agb">            
            <p><input type = "checkbox" name="agb" id="agb" />        
            С публичным <a class = "policy" href="http://imperia33.ru/oferta" target="_blank">догвором оферта</a> ознакомлены и согласны</p>
            </div>
        </td>
     </tr>
     <?php }?>
