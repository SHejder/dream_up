...
// $gantry_path_j34 = JPATH_SITE . '/components/com_gantry5/gantry5.php';

$gantry_path = '';
if (version_compare(JVERSION, '1.5', '>=') && version_compare(JVERSION, '1.6', '<'))
    $gantry_path = $gantry_path_j15;
else if ((version_compare(JVERSION, '1.6', '>=')) /*&& version_compare(JVERSION, '3.4', '<')*/)
    $gantry_path = $gantry_path_j16;
// else if (version_compare(JVERSION, '3.4', '>='))
//     $gantry_path = $gantry_path_j34;
